...
def make_embedding_call(
    *,
    ...
    """Build a raw dict for an EMBEDDING_CALL audit event (Phase E4)."""
    return {
        "event_id":          str(ULID()),
        "schema_version":    "1.0",
        "org_id":            org_id,
...
def make_a2a_event(
    *,
    ...
    """Build a raw dict for an A2A_MESSAGE_SEND or A2A_MESSAGE_RECEIVE audit event (Phase E7)."""
    return {
        "event_id":          str(ULID()),
        "schema_version":    "1.0",
        "org_id":            org_id,
        ...
        "payload": {
            ...
            "text_part_count":     len(text_parts or []),
            "artifact_text_count": len(artifact_texts or []),
...
def make_media_call(
    *,
    ...
    """Build a raw dict for IMAGE_GEN_CALL or AUDIO_CALL audit events (Phase E5)."""
    return {
        "event_id":          str(ULID()),
        "schema_version":    "1.0",
        "org_id":            org_id,
