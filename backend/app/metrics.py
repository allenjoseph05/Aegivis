...
Metrics exported:
  aegivis_events_ingested_total   -- Events ingested by event_type
  aegivis_anomalies_detected_total -- Anomalies detected by rule_id and severity
  aegivis_api_request_duration_ms  -- API request duration by endpoint

Optional dependency: prometheus-client>=0.21.0
Install: pip install 'aegivis-backend[observability]'
"""
...
def _init_metrics():
    ...
    try:
        ...
        anomalies_detected_total = Counter(
            "aegivis_anomalies_detected_total",
        ...
        api_request_duration_ms = Histogram(
            "aegivis_api_request_duration_ms",
