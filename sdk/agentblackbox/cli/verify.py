"""
CLI command: agentblackbox verify --session <session_id>
...
API_KEY = os.environ.get("ABB_BACKEND_API_KEY", "dev-dashboard-key")
...
def main():
    parser = argparse.ArgumentParser(
        description="AgentBlackBox — verify audit trail integrity",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Examples:
  agentblackbox verify --session sess_abc123def456
  agentblackbox verify --session sess_abc123def456 --org my-company
  ABB_BACKEND_URL=https://abb.mycompany.com agentblackbox verify --session sess_xxx
        """,
    )
