"""
Aegivis Python SDK - session context manager.
...
class Session:
    ...
    def __init__(
        ...
        os.environ["AEGIVIS_SESSION_ID"] = self.session_id
        os.environ["AEGIVIS_AGENT_ID"] = self.agent_id
...
def session(
    ...
    """
    Create a new Aegivis session context.
